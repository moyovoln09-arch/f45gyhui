# VLESS/Trojan Key Tester (Linux, sing-box, Python)

Скрипт тестирует список `vless://` и `trojan://` ключей через локальный `sing-box`, считает средний балл и показывает **топ-5**.
...
hysteria2://password@host:443?obfs=salamander&obfs-password=pwd#name
```
