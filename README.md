...
hysteria2://password@host:443?up_mbps=200&down_mbps=200&sni=example.com&obfs=salamander&obfs-password=secret#name
```
...
- В файле `config.json`: готовый клиентский конфиг `sing-box` с балансировкой нагрузки (random) между лучшими серверами.
