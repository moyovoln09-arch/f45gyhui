...
hysteria2://password@host:443?sni=example.com&obfs=password&obfs-password=secret#name
```
...
- `--export-singbox <path>`: Экспортировать лучшие ключи в конфигурацию `sing-box` с рандомизацией и балансировкой нагрузки.
- `--no-shuffle-output`: Отключить перемешивание ключей в экспортируемом конфиге.
