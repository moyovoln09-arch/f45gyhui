...
def parse_link(link: str) -> Tuple[str, Dict]:
    ...
    if scheme in {"vless", "trojan"}:
        ...
        outbound["tls"] = {
            ...
            "insecure": qs.get("insecure", qs.get("allowInsecure", "0"))
            in {"1", "true", "True"},
        }
...
def main() -> None:
    ...
    parser.add_argument(
        "--no-shuffle-output", action="store_true", help="Disable output config randomization"
    )
    ...
    if args.export_singbox:
        ...
        print(f"[+] Sing-box configuration exported to: {args.export_singbox}")
