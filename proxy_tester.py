...
def parse_link(link: str, default_bandwidth: int = 200) -> Tuple[str, Dict]:
    ...
    # Hysteria and Hysteria2 always use TLS in sing-box, but we can set SNI and insecure
...
def evaluate_key(
    key: str, timeout_s: int, sites: List[str], magnet: str, yt_url: str, default_bandwidth: int = 200
) -> TestResult:
...
def main() -> None:
    ...
    parser.add_argument("--hy-bandwidth", type=int, default=200, help="Default bandwidth in Mbps for Hysteria/Hysteria2")
