...
def test_parse_hysteria_v1_link():
    link = "hysteria://auth_string@1.2.3.4:1234?sni=test.com&obfs=magic&up=50&down=100"
...
def test_parse_hysteria_v1_defaults():
    ...
    assert outbound["tls"]["server_name"] == "1.1.1.1"
...
def test_parse_link_custom_bandwidth():
    link = "hy2://pass@1.1.1.1:1234"
